...
#   filename:  https://raw.githubusercontent.com/uselotus/lotus/diego/plans-redesign-v2/docs/openapi.yaml
#   timestamp: 2023-03-09T06:28:50+00:00
...
class AddOnSubscriptionRecordCreateRequest(BaseModel):
    ...
    addon_version_id: Optional[UUID] = Field(
...
class DynamicFixedChargeInitialValueRequest(BaseModel):
...
class NetsuiteInvoiceCSVView(BaseModel):
    url: AnyUrl
...
class SubscriptionRecordCreateRequest(BaseModel):
    ...
    dynamic_fixed_charges_initial_units: Optional[
        List[DynamicFixedChargeInitialValueRequest]
    ] = Field(
        None,
...
class SubscriptionRecordSwitchPlanRequest(BaseModel):
    switch_plan_version_id: Optional[UUID] = Field(
        None, description='The new plan version to switch to.'
    )
...
class Customer(BaseModel):
    ...
    timezone: Timezone
    tax_providers: List[TaxProvider]
