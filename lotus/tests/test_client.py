...
class TestClient:
    ...
    def test_basic_track_event(self):
        client = self.client
        success, msg = client.track_event(
        ...
        assert msg["idempotency_id"] == "idempotency_id"
    ...
    def test_stringifies_distinct_id(self):
        ...
        client = self.client
        success, msg = client.track_event(
            idempotency_id=157963456373623802,
            event_name="python test event",
        ...
        assert msg["idempotency_id"] == "157963456373623802"
    ...
    def test_basic_create_customer(self, create_customer_example):
        ...
        assert msg["customer_id"] == "distinct_id"
    ...
    def test_basic_create_subscription(self, create_subscription_example):
        ...
        assert msg["billing_plan_id"] == "billing_plan_id"
    ...
    def test_flush(self, track_event_example):
        ...
        assert client.queue["track_event"].empty() == True
    ...
    def test_success_on_invalid_api_key(self, track_event_example):
    ...
    def test_user_defined_flush_at(self, track_event_example):
        client = Client("testsecret", on_error=self.fail, flush_at=10, flush_interval=3)

        def mock_post_fn(*args, **kwargs):
            assert len(kwargs["batch"]) == 10
